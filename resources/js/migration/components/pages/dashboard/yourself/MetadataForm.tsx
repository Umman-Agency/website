...
const MetadataForm = ({ onSubmit }: { onSubmit: DataCapture }) => {
  ...
  return <>
    <form onSubmit={genericHandle(filter ,onSubmit)} className="bg-white rounded-xl shadow-sm border border-gray-100 w-full max-w-2xl p-10">
      ...
      <div className="flex justify-end">
        <button type="submit" className="bg-umman-purple text-white px-10 py-3 rounded-xl font-bold text-sm shadow-lg shadow-purple-200 hover:bg-opacity-90 transition">
          Continuar
        </button>
      </div>
    </form>
