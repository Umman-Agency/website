          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            delay: 0.2
              ...
              <h1 className="text-6xl md:text-8xl font-bold text-white uppercase mb-6 leading-tight">
                Connect <span className="text-accent-clearBlue">with us</span>
              </h1>
              ...
              delay: 1
                  ...
                  <a href="#" className="text-lg text-gray-300 hover:text-accent-clearBlue transition-colors duration-300">LinkedIn</a>
                  <a href="#" className="text-lg text-gray-300 hover:text-accent-clearBlue transition-colors duration-300">Dribbble</a>
                  <a href="#" className="text-lg text-gray-300 hover:text-accent-clearBlue transition-colors duration-300">Behance</a>
              </motion.div>
            </motion.div>
            ...
            <div>
              ...
              <motion.div className="overflow-hidden rounded-2xl shadow-2xl shadow-accent-clearBlue/10" initial={{
              opacity: 0,
              y: 30
            }} animate={{
              opacity: 1,
              ...
              delay: 0.8
                ...
                <img class="w-full h-auto object-cover" alt="Modern office space with creative design elements" src="https://horizons-cdn.hostinger.com/258a96df-c479-4700-b7e2-08531e163395/modern-office-concentration-RCQmi.png" />
              </motion.div>
            </div>
          </div>
        </div>
