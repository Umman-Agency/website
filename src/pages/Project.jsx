      ...
      <main>
        ...
        <SectionAnimator>
            <div className="container mx-auto px-6 mb-16">
                 <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl shadow-accent-clearBlue/10">
                    <img class="w-full h-full object-cover" alt={project.images.hero.alt} src="https://horizons-cdn.hostinger.com/258a96df-c479-4700-b7e2-08531e163395/gemini_generated_image_n6u5epn6u5epn6u5-5ABrF.png" />
                 </div>
            </div>
        </SectionAnimator>
                ...
                <div className="grid grid-cols-1 gap-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="aspect-square rounded-2xl overflow-hidden">
                           <img class="w-full h-full object-cover" alt={project.images.gallery[1].alt} src="https://horizons-cdn.hostinger.com/258a96df-c479-4700-b7e2-08531e163395/gemini_generated_image_mxgp1bmxgp1bmxgp-IDwMQ.png" />
                        </div>
                        <div className="aspect-square rounded-2xl overflow-hidden">
                            <img class="w-full h-full object-cover" alt={project.images.gallery[2].alt} src="https://horizons-cdn.hostinger.com/258a96df-c479-4700-b7e2-08531e163395/gemini_generated_image_mxgp1bmxgp1bmxgp-1-RqwfI.png" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <SectionAnimator>
            <div className="container mx-auto px-6 mb-16">
                <div className="aspect-video rounded-2xl overflow-hidden">
                    <img class="w-full h-full object-cover" alt={project.images.gallery2[0].alt} src="https://horizons-cdn.hostinger.com/258a96df-c479-4700-b7e2-08531e163395/professional-exchange-BmQpX.png" />
                </div>
            </div>
        </SectionAnimator>
            ...
            <section className="py-24 text-center">
                <div className="container mx-auto px-6">
                    ...
                    <p className="text-lg text-gray-400 mb-8">Let's discuss your next big idea and how we can bring it to life.</p>
                     <Button asChild size="lg" className="bg-accent-clearBlue text-white hover:bg-accent-clearBlue/90 group rounded-full text-lg py-7 px-10">
                        <Link to="/contact">
