                                ...
                                {section.links.map((link) => (
                                    <li key={link.name}>
                                        <a 
                                          ...
                                          className="text-gray-400 hover:text-accent-clearBlue transition-colors duration-300">
                                            {link.name}
                                        </a>
                                    </li>
                                ))}
                     ...
                     <div>
                        ...
                        <div className="flex space-x-4">
                            {socialLinks.map((social) => (
                                <button key={social.name} onClick={handleSocialClick} className="text-gray-400 hover:text-accent-clearBlue transition-colors duration-300">
                                    {social.icon}
                                </button>
                            ))}
                        </div>
